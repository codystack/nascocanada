                                ...
                                <div class="col-lg-12">
                                    <div class="card bg-opaque-white">
                                        ...
                                        <div class="card-body bg-white text-center">
                                            ...
                                            <p class="text-dark fw-light fs-6 mb-2">Hello! <span class="fw-bold"><?php echo $_SESSION['firstName']; ?>,</span> you successfully completed the loan application, <br>contact admin for payment processing</p>
